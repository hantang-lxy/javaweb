                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills flex-column">
                                <a href="${pageContext.request.contextPath}/userInfo.action?methodName=getUserInfo"
                                   class="nav-link active"><i class="fa fa-user"></i>我的账户</a>
                                <a href="${pageContext.request.contextPath}/order.action?methodName=showOrders"
                                   class="nav-link"><i class="fa fa-list"></i>我的订单</a>
                    ...
                    <div class="box">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>原密码</label>
                                        <input id="password_0" type="password" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <!--<a class="btn btn-primary" onclick="resetPwd()">修改密码</a>-->
                                <button type="button" class="btn btn-primary" onclick="resetPwd()">修改密码</button>
                            </div>
                        </form>
                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>昵称</label>
                                        <input id="nickname" type="text" value="${requestScope.userInfo.data.UNickname}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>手机号</label>
                                        <input id="mobile" type="text" value="${requestScope.userInfo.data.UPhone}"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="text" value="${requestScope.userInfo.data.UMail}"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 text-center">
                                    <button type="button" class="btn btn-primary" onclick="resetInfo()">
                                        重置
                                    </button>
...
<script>
    ...
    if (pwdResult == "fail") {
        ...
        location.replace("${pageContext.request.contextPath}/person.action?methodName=logoutByRepass");
    }
