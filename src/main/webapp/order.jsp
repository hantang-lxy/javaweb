        ...
        <div class="container">
            <div class="row">
                ...
                <div id="customer-orders" class="col-lg-9">
                    <div class="box">
                        <h1>我的订单</h1>
                        <p class="lead">你的订单在一个地方</p>
                        <p class="text-muted">如果有任何问题，请随时提出来 <a href="contact.html">联系我们</a>, 我们的客户服务中心全天候为您服务。</p>
                        <hr>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach items="${requestScope.orderMap.data}" var="Order" varStatus="status">
                                    <tr>
                                        <th>#${Order.ONum}</th>
                                        <td>${Order.ODate}</td>
                                        <td>${Order.OMoney}元</td>
                                        <c:if test="${Order.OState == 1}">
                                            <td><span class="badge badge-info">未完成</span></td>
                                        </c:if>
                                        ...
                                        <td><a href="orderItem.action?methodName=showOrderItems&oid=${Order.ONum}"
